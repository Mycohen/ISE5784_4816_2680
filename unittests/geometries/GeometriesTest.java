...
public class GeometriesTest {
    ...
    void testFindIntersections() {
        ...
        assertNull(geometries.findIntersections(rayOut),
                "Ray does not intersect any of the geometries");
        ...
        assertEquals(4, geometries2.findIntersections(ray4).size(),
                "Ray intersects all the geometries");

        //TC05: Ray intersects one of the geometries
        Ray ray5 = new Ray(new Point(0, 1, 0),
                new Vector (0, 0.00814685061326, 2.727321605144383));
        assertEquals(1, geometries2.findIntersections(ray5).size(),
                "Ray intersects one of the geometries");
